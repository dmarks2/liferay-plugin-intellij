...
public class SiteInitializerXmlSchemaProviderTest extends BasePlatformTestCase {
	...
	protected String getTestDataPath() {
		return "testdata/de/dm/intellij/liferay/site/initializer/SiteInitializerXmlSchemaProviderTest";
	}

	public void testDDMStructureCompletion() {
