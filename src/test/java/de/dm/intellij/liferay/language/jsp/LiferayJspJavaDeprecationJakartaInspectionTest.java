...
public class LiferayJspJavaDeprecationJakartaInspectionTest extends LightJavaCodeInsightFixtureTestCase {
	...
	public void testServletInsideJSPImportDeprecation() {
		...
		myFixture.checkResultByFile("servlet_expected.jsp");
	}
}
