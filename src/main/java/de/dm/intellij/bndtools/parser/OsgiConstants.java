...
public interface OsgiConstants {
    ...
    String NONE = "none";
    String[] directives = new String[]{"-split-package:", "-noimport:", "-import:", "resolution:", "include:", "uses:", "exclude:", "keystore:", "provider:", "password:", "sign-password:", "command:", "-noannotations", "lib:", "from:", "private:", "literal", "effective:", "filter:", "restrict:", "replace:", "is:", "gradle", "gradle_native", "ant", "eclipse", "maven", "intellij", "sbt", "osmorc", "capability:", "requirement:"};
    String USES_USES = "<<USES>>";
    String CURRENT_USES = "@uses";
    String IMPORT_REFERENCE = "reference";
    String IMPORT_PRIVATE = "private";
    String[] importDirectives = new String[]{"reference", "private"};
    Pattern VALID_PROPERTY_TYPES = Pattern.compile("(String|Long|Double|Float|Integer|Byte|Character|Boolean|Short)");
    ...
    String[] METAPACKAGES = new String[]{"META-INF", "OSGI-INF", "OSGI-OPT"};
    ...
    String[] componentDirectives = new String[]{"factory:", "immediate:", "enabled:", "dynamic:", "multiple:", "provide:", "optional:", "properties:", "implementation:", "servicefactory:", "version:", "configuration-policy:", "modified:", "activate:", "deactivate:", "name:", ".descriptors:", "designate:", "designateFactory:", "greedy:", "xmlns:"};
    Set<String> SET_COMPONENT_DIRECTIVES = new HashSet(Arrays.asList(componentDirectives));
    Set<String> SET_COMPONENT_DIRECTIVES_1_1 = new HashSet(Arrays.asList("version:", "configuration-policy:", "modified:", "activate:", "deactivate:"));
    Set<String> SET_COMPONENT_DIRECTIVES_1_2 = new HashSet(Arrays.asList("greedy:"));
