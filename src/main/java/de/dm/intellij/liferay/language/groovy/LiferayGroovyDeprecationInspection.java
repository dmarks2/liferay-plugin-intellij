...
public class LiferayGroovyDeprecationInspection extends AbstractLiferayDeprecationInspection<LiferayGroovyDeprecationInfoHolder> {
	...
	static {
		...
		GROOVY_DEPRECATIONS.addAll(createImportStatements(LiferayJavaDeprecations.LPS_193319_WORKFLOW_DEFINITION_MANAGER).version("7.4.3.92"));
		...
		GROOVY_DEPRECATIONS.addAll(createImportStatements(LiferayJavaDeprecations.LPS_188270_CONFIGURATION_PROVIDER).version(LiferayVersions.LIFERAY_2024_Q1_CE));
		GROOVY_DEPRECATIONS.addAll(createImportStatements(LiferayJavaDeprecations.LPS_198887_OPEN_ID_UTIL).version(LiferayVersions.LIFERAY_2024_Q4_CE));
		GROOVY_DEPRECATIONS.addAll(createImportStatements(LiferayJavaDeprecations.LPS_197267_PERMISSION_CONVERTER_UTIL).version(LiferayVersions.LIFERAY_2024_Q4_CE));
		GROOVY_DEPRECATIONS.addAll(createImportStatements(LiferayJavaDeprecations.LPS_196101_PORTLET_PERMISSION).version(LiferayVersions.LIFERAY_2024_Q4_CE));
		...
		GROOVY_DEPRECATIONS.addAll(createImportStatements(LiferayJavaDeprecations.LPD_7822_SEARCH_PERMISSION_FILTER).version(LiferayVersions.LIFERAY_2024_Q3_CE));
		GROOVY_DEPRECATIONS.addAll(createImportStatements(LiferayJavaDeprecations.LPD_28526_DESTINATION_WRAPPER).version(LiferayVersions.LIFERAY_2024_Q3_CE));
		GROOVY_DEPRECATIONS.addAll(createImportStatements(LiferayJavaDeprecations.LPD_8352_INDEX_SETTINGS_CLASSES).version(LiferayVersions.LIFERAY_2024_Q3_CE));
		GROOVY_DEPRECATIONS.addAll(createImportStatements(LiferayJavaDeprecations.LPD_39461_FRAGMENT_JAVASCRIPT_CONFIGURATION).version(LiferayVersions.LIFERAY_2025_Q1_CE));
		GROOVY_DEPRECATIONS.addAll(createImportStatements(LiferayJavaDeprecations.LPD_36036_JSP_TAGLIB_HELPER).version(LiferayVersions.LIFERAY_2025_Q1_CE));
		GROOVY_DEPRECATIONS.addAll(createImportStatements(LiferayJavaDeprecations.LPD_50859_ITEM_SELECTOR_CRITERION).version(LiferayVersions.LIFERAY_2025_Q2));
		GROOVY_DEPRECATIONS.addAll(createImportStatements(LiferayJavaDeprecations.LPD_50859_ITEM_SELECTOR_CRITERION_2025_Q3).version(LiferayVersions.LIFERAY_2025_Q3));
		GROOVY_DEPRECATIONS.addAll(createImportStatements(LiferayJavaDeprecations.LPD_46462_JAKARTA_MIGRATION).version(LiferayVersions.LIFERAY_2025_Q3));
		...
		GROOVY_DEPRECATIONS.addAll(createMethodCalls(LiferayJavaDeprecations.LPD_28051_PORTAL_UTIL_INIT_CUSTOM_SQL).version(LiferayVersions.LIFERAY_2024_Q3_CE));
		GROOVY_DEPRECATIONS.addAll(createMethodCalls(LiferayJavaDeprecations.LPD_1909_USER_LOCAL_SERVICE_DECRYPT_USER_ID).version(LiferayVersions.LIFERAY_2024_Q3_CE));
		GROOVY_DEPRECATIONS.addAll(createMethodCalls(LiferayJavaDeprecations.LPD_1536_DL_STORE_UTIL_SET_STORE).version(LiferayVersions.LIFERAY_2024_Q3_CE));
		GROOVY_DEPRECATIONS.addAll(createMethodCalls(LiferayJavaDeprecations.LPS_200501_IS_STARTUP_FINISHED).version(LiferayVersions.LIFERAY_2024_Q4_CE));
		...
		GROOVY_DEPRECATIONS.addAll(createMethodCalls(LiferayJavaDeprecations.LPD_65748_BATCH_ENGINE_EXPORT).version(LiferayVersions.LIFERAY_2025_Q4));
		GROOVY_DEPRECATIONS.addAll(createMethodCalls(LiferayJavaDeprecations.LPD_58844_PORTAL_MAIL_ID).version(LiferayVersions.LIFERAY_2025_Q4));
	}
