...
public class LiferayTaglibSimpleAttributesCompletionContributor extends CompletionContributor {
    ...
    public LiferayTaglibSimpleAttributesCompletionContributor() {
        extend(
    ...
    private static PsiElementPattern.Capture<PsiElement> getTaglibPattern(Map<String, Collection<AbstractMap.SimpleEntry<String, String>>> taglibMap) {
        return
