...
public class LiferayPropertiesDeprecationInspection extends AbstractLiferayDeprecationInspection<LiferayPropertiesDeprecationInfoHolder> {
	...
	static {
		...
		PROPERTY_DEPRECATIONS.addAll(createProperties(7.4f, "The property company.security.auth.requires.https encourages bad behaviour, and has been removed.", "LPS-190442",
				"company.security.auth.requires.https").quickfix(removeProperty()).version("7.4.3.106"));
		...
		PROPERTY_DEPRECATIONS.addAll(createPropertiesWithFilenamePrefix(7.2f, "Portal property \"${propertyName}\" is obsolete", "", "portal",
