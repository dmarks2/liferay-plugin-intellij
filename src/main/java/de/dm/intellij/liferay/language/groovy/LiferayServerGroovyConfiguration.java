...
public class LiferayServerGroovyConfiguration extends LocatableConfigurationBase<RunConfigurationOptions> implements CommonJavaRunConfigurationParameters, RefactoringListenerProvider {
    ...
    @Override
    protected @NotNull LiferayServerGroovyConfigurationOptions getOptions() {
        return (LiferayServerGroovyConfigurationOptions)super.getOptions();
    }

    @Override
    public @NotNull SettingsEditor<LiferayServerGroovyConfiguration> getConfigurationEditor() {
        SettingsEditorGroup<LiferayServerGroovyConfiguration> group = new SettingsEditorGroup<>();

        String title = ExecutionBundle.message("run.configuration.configuration.tab.title");

        group.addEditor(title, new LiferayServerGroovyConfigurationSettingsEditor(getProject()));
