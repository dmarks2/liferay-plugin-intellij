...
public class LiferayJavaDeprecations {
	...
	public static LiferayJavaDeprecations.JavaImportDeprecation LPD_50859_ITEM_SELECTOR_CRITERION = new LiferayJavaDeprecations.JavaImportDeprecation(
			7.4f,
			"The .criterion package has been removed from several ItemSelectorCriterion classes",
			"LPD-50859",
			new String[] {
					"com.liferay.asset.categories.item.selector.criterion.AssetCategoryTreeNodeItemSelectorCriterion",
					"com.liferay.asset.categories.item.selector.criterion.AssetVocabularyItemSelectorCriterion",
					"com.liferay.asset.categories.item.selector.criterion.AssetTagsItemSelectorCriterion",
					"com.liferay.asset.categories.item.selector.criterion.AssetDisplayPageSelectorCriterion",
					"com.liferay.wiki.item.selector.criterion.WikiAttachmentItemSelectorCriterion",
					"com.liferay.wiki.item.selector.criterion.WikiPageItemSelectorCriterion",
					"com.liferay.fragment.item.selector.criterion.FragmentEntryItemSelectorCriterion",
					"com.liferay.fragment.item.selector.criterion.FragmentCollectionItemSelectorCriterion",
					"com.liferay.client.extension.type.item.selector.criterion.CETItemSelectorCriterion",
					"com.liferay.blogs.item.selector.criterion.BlogsItemSelectorCriterion",
					"com.liferay.segments.item.selector.criterion.SegmentsEntryItemSelectorCriterion",
					"com.liferay.segments.item.selector.criterion.SegmentsExperienceItemSelectorCriterion",
					"com.liferay.info.list.provider.item.selector.criterion.InfoListProviderItemSelectorCriterion",
					"com.liferay.info.field.provider.item.selector.criterion.InfoFieldItemSelectorCriterion",
					"com.liferay.info.collection.provider.item.selector.criterion.InfoCollectionProviderItemSelectorCriterion",
					"com.liferay.info.collection.provider.item.selector.criterion.RelatedInfoItemCollectionProviderItemSelectorCriterion",
					"com.liferay.info.collection.provider.item.selector.criterion.RepeatableFieldInfoCollectionProviderItemSelectorCriterion",
					"com.liferay.site.navigation.item.selector.criterion.SiteNavigationMenuItemItemSelectorCriterion",
					"com.liferay.site.navigation.item.selector.criterion.SiteNavigationMenuItemSelectorCriterion",
					"com.liferay.journal.item.selector.criterion.JournalItemSelectorCriterion",
					"com.liferay.knowledge.base.item.selector.criterion.KBAttachmentItemSelectorCriterion",
					"com.liferay.site.teams.item.selector.criterion.SiteTeamsItemSelectorCriterion",
					"com.liferay.site.item.selector.criterion.SiteItemSelectorCriterion",
					"com.liferay.dynamic.data.mapping.item.selector.criterion.DDMUserPersonalFolderItemSelectorCriterion",
					"com.liferay.dynamic.data.mapping.form.item.selector.criterion.DDMUserPersonalFolderItemSelectorCriterion",
					"com.liferay.roles.item.selector.organization.role.OrganizationRoleItemSelectorCriterion",
					"com.liferay.roles.item.selector.regular.role.RegularRoleItemSelectorCriterion",
					"com.liferay.roles.item.selector.site.role.SiteRoleItemSelectorCriterion",
					"com.liferay.layout.page.template.item.selector.criterion.LayoutPageTemplateCollectionItemSelectorCriterion",
					"com.liferay.layout.page.template.item.selector.criterion.LayoutPageTemplateCollectionTreeNodeItemSelectorCriterion",
					"com.liferay.layout.page.template.item.selector.criterion.LayoutPageTemplateCollectionTreeNodeItemSelectorCriterion",
			},
			new String[] {
					"com.liferay.asset.categories.item.selector.AssetCategoryTreeNodeItemSelectorCriterion",
					"com.liferay.asset.categories.item.selector.AssetVocabularyItemSelectorCriterion",
					"com.liferay.asset.categories.item.selector.AssetTagsItemSelectorCriterion",
					"com.liferay.asset.categories.item.selector.AssetDisplayPageSelectorCriterion",
					"com.liferay.wiki.item.selector.WikiAttachmentItemSelectorCriterion",
					"com.liferay.wiki.item.selector.WikiPageItemSelectorCriterion",
					"com.liferay.fragment.item.selector.FragmentEntryItemSelectorCriterion",
					"com.liferay.fragment.item.selector.FragmentCollectionItemSelectorCriterion",
					"com.liferay.client.extension.type.item.selector.CETItemSelectorCriterion",
					"com.liferay.blogs.item.selector.BlogsItemSelectorCriterion",
					"com.liferay.segments.item.selector.SegmentsEntryItemSelectorCriterion",
					"com.liferay.segments.item.selector.SegmentsExperienceItemSelectorCriterion",
					"com.liferay.info.list.provider.item.selector.InfoListProviderItemSelectorCriterion",
					"com.liferay.info.field.provider.item.selector.InfoFieldItemSelectorCriterion",
					"com.liferay.info.collection.provider.item.selector.InfoCollectionProviderItemSelectorCriterion",
					"com.liferay.info.collection.provider.item.selector.RelatedInfoItemCollectionProviderItemSelectorCriterion",
					"com.liferay.info.collection.provider.item.selector.RepeatableFieldInfoCollectionProviderItemSelectorCriterion",
					"com.liferay.site.navigation.item.selector.SiteNavigationMenuItemItemSelectorCriterion",
					"com.liferay.site.navigation.item.selector.SiteNavigationMenuItemSelectorCriterion",
					"com.liferay.journal.item.selector.JournalItemSelectorCriterion",
					"com.liferay.knowledge.base.item.selector.KBAttachmentItemSelectorCriterion",
					"com.liferay.site.teams.item.selector.SiteTeamsItemSelectorCriterion",
					"com.liferay.dynamic.data.mapping.item.selector.DDMUserPersonalFolderItemSelectorCriterion",
					"com.liferay.dynamic.data.mapping.form.item.selector.DDMUserPersonalFolderItemSelectorCriterion",
					"com.liferay.roles.item.selector.OrganizationRoleItemSelectorCriterion",
					"com.liferay.roles.item.selector.RegularRoleItemSelectorCriterion",
					"com.liferay.roles.item.selector.SiteRoleItemSelectorCriterion",
					"com.liferay.layout.page.template.item.selector.LayoutPageTemplateCollectionItemSelectorCriterion",
