...
public abstract class PoshiDefinitionBaseImpl extends ASTWrapperPsiElement implements PoshiDefinitionBase {

  public PoshiDefinitionBaseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PoshiVisitor visitor) {
    visitor.visitDefinitionBase(this);
  }
