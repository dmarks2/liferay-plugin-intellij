...
public class PoshiFunctionDefinitionImpl extends PoshiDefinitionBaseImpl implements PoshiFunctionDefinition {

  public PoshiFunctionDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
