...
public class PoshiStructuresImpl extends ASTWrapperPsiElement implements PoshiStructures {

  public PoshiStructuresImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PoshiVisitor visitor) {
    visitor.visitStructures(this);
  }
  ...
  @Override
  @NotNull
  public PoshiStructureKeywords getStructureKeywords() {
    return findNotNullChildByClass(PoshiStructureKeywords.class);
  }
