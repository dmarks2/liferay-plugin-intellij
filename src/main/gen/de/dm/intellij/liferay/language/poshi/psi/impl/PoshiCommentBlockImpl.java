...
public class PoshiCommentBlockImpl extends ASTWrapperPsiElement implements PoshiCommentBlock {

  public PoshiCommentBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getBlockComment() {
    return findNotNullChildByType(BLOCK_COMMENT);
  }
