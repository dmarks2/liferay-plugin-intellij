...
public class PoshiContinueStatementImpl extends ASTWrapperPsiElement implements PoshiContinueStatement {

  public PoshiContinueStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
